(function () {
  ...
  if (
    ...
    bindEvent(window, 'message', (e) => {
      ...
      $('select:not(.selectize,.no-auto-select2)').val(e.data);
      $('select:not(.selectize,.no-auto-select2)').select2('destroy');
      $('select:not(.selectize,.no-auto-select2)').select2();
    });
...
/*
$("select:not(.selectize,.no-auto-select2)").val("354");
$("select:not(.selectize,.no-auto-select2)").select2("destroy");
$("select:not(.selectize,.no-auto-select2)").select2();*/
